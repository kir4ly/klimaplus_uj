...
export default function UrlapPage() {
  ...
  return (
    <main className="relative isolate flex min-h-screen flex-col font-body">
      {/* Meta Pixel - OLD pixel ONLY for the old /urlap page */}
      <Script id="meta-pixel-urlap" strategy="afterInteractive">{`
        ...
        fbq('init','1452932669308796');fbq('track','PageView');
      `}</Script>
      <noscript>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img height="1" width="1" style={{ display: "none" }} alt="" src="https://www.facebook.com/tr?id=1452932669308796&ev=PageView&noscript=1" />
      </noscript>
